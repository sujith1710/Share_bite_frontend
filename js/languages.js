// Simple language switcher for FeedHope
class LanguageSwitcher {
    constructor() {
        this.currentLanguage = localStorage.getItem('FeedHope_language') || 'en';
        this.translations = {};
    ...
    loadTranslations() {
        ...
        this.translations = {
            en: {
                ...
                'about.description': 'FeedHope is a revolutionary platform designed to tackle food waste.',
            ...
            hi: {
                ...
                'about.description': 'FeedHope एक क्रांतिकारी मंच है जो खाद्य अपशिष्ट से निपटने के लिए डिज़ाइन किया गया है।',
            ...
            bn: {
                ...
                'about.description': 'FeedHope একটি বিপ্লবী প্ল্যাটফর্ম যা খাদ্য বর্জ্য মোকাবেলা করতে ডিজাইন করা হয়েছে।',
            ...
            mr: {
                ...
                'about.description': 'FeedHope हा एक क्रांतिकारी मंच आहे जो खाद्य कचरा कमी करण्यासाठी डिजाइन केलेला आहे।',
            ...
            ta: {
                ...
                'about.description': 'FeedHope என்பது உணவு கழிவுகளை எதிர்கொள்ள ஒரு புரட்சிகர மंच।',
            ...
            te: {
                ...
                'about.description': 'FeedHope అనేది ఆహార వ్యర్థాలను ఎదుర్కోవటానికి ఒక విప్లవ ప్లాట్‌ఫారమ్.',
            ...
            gu: {
                ...
                'about.description': 'FeedHope એક ક્રાંતિકારી પ્લેટફોર્મ છે જે ખાદ્ય કચરો સામે લડવા માટે ડિઝાઇન કરાયેલ છે।',
    ...
    setLanguage(lang) {
        if (this.translations[lang]) {
            ...
            localStorage.setItem('FeedHope_language', lang);
