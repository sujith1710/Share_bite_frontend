...
export default {
  ...
  // Hero Section
  'hero.title': 'খাদ্য বর্জ্য কমান, সম্প্রদায়কে খাওয়ান',
  'hero.subtitle': 'সম্প্রদায়কে খাওয়ান',
  'hero.description': 'রেস্তোরাঁ এবং পরিবারগুলিকে এনজিও এবং স্বেচ্ছাসেবকদের সাথে সংযুক্ত করুন তাজা বাকি খাবার পুনর্বিতরণ করতে এবং বর্জ্য কমানোর সময় ক্ষুধার বিরুদ্ধে লড়াই করতে।',
  'hero.donateFood': 'খাবার দান করুন',
  'hero.findFood': 'খাবার খুঁজুন',
  'hero.mealsSaved': 'বাঁচানো খাবার',
  'hero.activeDonors': 'সক্রিয় দাতা',
  ...
  'features.connectDesc': 'আমাদের প্ল্যাটফর্ম দাতাদের এনজিও এবং স্বেচ্ছাসেবকদের সাথে তাৎক্ষণিকভাবে সংযুক্ত করে।',
