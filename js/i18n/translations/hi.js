...
export default {
  ...
  // Hero Section
  'hero.title': 'खाद्य अपशिष्ट को कम करें, समुदायों को खिलाएं',
  'hero.subtitle': 'समुदायों को खिलाएं',
  'hero.description': 'रेस्तरां और घरों को एनजीओ और स्वयंसेवकों से जोड़ें ताकि ताजा बचा हुआ भोजन वितरित किया जा सके और भूख से लड़ते हुए अपशिष्ट कम किया जा सके। एक बेहतर भविष्य के लिए एक टिकाऊ समाधान।',
  'hero.donateFood': 'भोजन दान करें',
  'hero.findFood': 'भोजन खोजें',
  'hero.mealsSaved': 'बचाए गए भोजन',
  'hero.activeDonors': 'सक्रिय दाता',
  ...
  'footer.forCollectors': 'संग्राहक के लिए',
