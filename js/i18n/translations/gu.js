...
export default {
  ...
  // Hero Section
  'hero.title': 'ખાદ્ય કચરો ઓછો કરો, સમુદાયોને ખવડાવો',
  'hero.subtitle': 'સમુદાયોને ખવડાવો',
  'hero.description': 'રેસ્તોરાં અને ઘરોને NGO અને સ્વયંસેવકો સાથે જોડો તાજા બાકી રહેલ ખાધ્યને પુનર્વિતરણ કરવા અને કચરો ઓછો કર્યા દરમિયાન ભૂખ સામે લડવા.',
  'hero.donateFood': 'ખાધ્ય દાન કરો',
  'hero.findFood': 'ખાધ્ય શોધો',
  'hero.mealsSaved': 'બચાયેલ ભોજન',
  'hero.activeDonors': 'સક્રિય દાતા',
  ...
  'features.connectDesc': 'અમારો પ્લેટફોર્મ દાતાઓને NGO અને સ્વયંસેવકો સાથે તાત્કાલિક જોડે છે.',
