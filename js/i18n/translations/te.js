...
export default {
  ...
  // Hero Section
  'hero.title': 'ఆహార వ్యర్థాలను తగ్గించండి, సమాజాలను దోषపూరితం చేయండి',
  'hero.subtitle': 'సమాజాలను దోషపూరితం చేయండి',
  'hero.description': 'డైనర్‌లు మరియు గృహాలను NGO‌లు మరియు స్వచ్ఛంద సేవకులకు కనెక్ట్ చేసి తాజా మిగిలిన ఆహారాన్ని పున: పంపిణీ చేయండి మరియు వ్యర్థాలను తగ్గిస్తూ ఆకలికి వ్యతిరేకంగా సంగ్రామం చేయండి.',
  'hero.donateFood': 'ఆహారాన్ని విరాళం ఇవ్వండి',
  'hero.findFood': 'ఆహారాన్ని కనుగొనండి',
  'hero.mealsSaved': 'సేవ్ చేసిన భోజనాలు',
  'hero.activeDonors': 'సక్రియ దాతలు',
  ...
  'features.connectDesc': 'మా ప్లాట్‌ఫారమ్ దాతలను NGO‌లు మరియు స్వచ్ఛంద సేవకులకు తక్షణ సమయానికి కనెక్ట్ చేస్తుంది.',
  'features.feed': 'సమాజాలను దోషపూరితం చేయండి',
  'features.feedDesc': 'సేకరించిన ఆహారం దానిని అత్యంత చేతిలో పెదవిలకు చేరుకుంటుంది.',
  ...
  'common.error': 'ఆ దీర్ఘ బాధ్యత యొక్క',
